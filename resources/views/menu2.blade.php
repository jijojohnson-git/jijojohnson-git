                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 text-center">
                        <ul id="masonry" class="dlab-gallery-listing gallery mfp-gallery text-center portfolio-bx p-l0 search-fil row">
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 combo wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s" data-filter-item data-filter-name="aaaa">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 combo wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="bbbb">
                                <div class="popular-item-wp text-center mb-2">
                                    <img src="images/featured/ft-1.png" class="w-100 mx-auto" alt="">
                                    <div class="pp-item-detail mt-3">
                                        <div class="upper-item-dt">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 combo wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="cccc">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Specials wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="d">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Specials wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="f">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Specials wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Starters wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Biriyani wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Curries wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Dosa wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Rice wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Pizza wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Sides wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
                            ...
                            <li class="card-container col-lg-3 col-md-4 col-sm-6 p-lr0 Salads wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s" data-filter-item data-filter-name="">
                                <div class="popular-item-wp text-center mb-2">
